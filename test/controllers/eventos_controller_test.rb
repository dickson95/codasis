...
class EventosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create evento" do
    assert_difference('Evento.count') do
      post eventos_url, params: { evento: { asunto: @evento.asunto, fecha: @evento.fecha, hora: @evento.hora, ubicacion: @evento.ubicacion } }
    end

    assert_redirected_to evento_path(Evento.last)
  end
  ...
  test "should update evento" do
    patch evento_url(@evento), params: { evento: { asunto: @evento.asunto, fecha: @evento.fecha, hora: @evento.hora, ubicacion: @evento.ubicacion } }
