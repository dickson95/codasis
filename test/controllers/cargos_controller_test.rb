...
class CargosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create cargo" do
    assert_difference('Cargo.count') do
      post cargos_url, params: { cargo: { dependencia: @cargo.dependencia, nombre: @cargo.nombre } }
    end
  ...
  test "should update cargo" do
    patch cargo_url(@cargo), params: { cargo: { dependencia: @cargo.dependencia, nombre: @cargo.nombre } }
